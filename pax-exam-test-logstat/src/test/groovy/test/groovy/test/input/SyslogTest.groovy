...
public class SyslogTest {
	...
	public void testSyslog_01() {
		...
		def outFile = ["path":wd + "/src/test/resources/data_test/input/testSyslog/output/testSyslog_01.log"]
	...
	public void testSyslog_02() {
		...
		def outFile = ["path":wd + "/src/test/resources/data_test/input/testSyslog/output/testSyslog_02.log"]
		output_conf.put("config", outFile)
		conf.put("input",input_conf);
		conf.put("filter",filter);
		conf.put("output",output_conf);
	...
	public void testSyslog_03() {
		...
		input_conf.put("log_type", "syslog");
		input_conf.put("from_time_generated", "Feb 25 12:53:50");
		def outFile = ["path":wd + "/src/test/resources/data_test/input/testSyslog/output/testSyslog_03.log"]
		output_conf.put("config", outFile)
	...
	public void testSyslog_04() {
		...
		input_conf.put("log_type", "syslog");
		input_conf.put("from_time_generated", "Feb 25 12:53:50");
		def outFile = ["path":wd + "/src/test/resources/data_test/input/testSyslog/output/testSyslog_04.log"]
		output_conf.put("config", outFile)
	...
	public void testSyslog_05() {
		...
		input_conf.put("from_time_generated", "Feb 25 12:53:50");
		def outFile = ["path":wd + "/src/test/resources/data_test/input/testSyslog/output/testSyslog_05.log"]
		output_conf.put("config", outFile)
	...
	public void testSyslog_06() {
		...
		input_conf.put("from_time_generated", "Feb 25 12:53:50");
		def outFile = ["path":wd + "/src/test/resources/data_test/input/testSyslog/output/testSyslog_06.log"]
		output_conf.put("config", outFile)
	...
	public void testSyslog_07() {
		...
		def outFile = ["path":wd + "/src/test/resources/data_test/input/testSyslog/output/testSyslog_07.log"]
		output_conf.put("config", outFile)
	...
	public void testSyslog_08() {
		...
		def outFile = ["path":wd + "/src/test/resources/data_test/input/testSyslog/output/testSyslog_08.log"]
		output_conf.put("config", outFile)
